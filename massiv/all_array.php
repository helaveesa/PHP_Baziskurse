...
// структура данных, создание многомерного массива последовательно
// первый способ
...
// добавим книгу и занесем ее на полку3

$bookshelf[3][1]['author'] = 'J. Vern'; // [3]-полка, [1]-номер книги, [ключ] = присваивание 'значение_ключа';
$bookshelf[3][1]['title'] = 'Puteshestvie k centru Zemli'; 
...
// см. рис. img - array_all_img
echo '<br><br>';
echo '<br><br>';

// второй способ с помощью функции array

$bookshelf2 = array(
	1 => array (
		1 => array ('author' => 'L. Tolstoi', 'title' => 'Voina i mir', 'year' => 2005);
		2 => array ('author' => 'N. Gogol', 'title' => 'Mertvie dushi', 'year' => 2000));
	2 => array (
		1 => array ('author' => 'R. Bredberry', 'title' => 'Vino iz oduvanchikov', 'year' => 2002);
		2 => ('author' => 'Ch. Dikkens', 'title' => 'Priklucheniya Olivera Tvista', 'year' => 2006)));
// выведем содержимое в браузер
echo '<br><br>';
...
// выведем инфу отдельно по какой либо книге или информации о книге в браузер
// элементы многомерного массива пишутся, в выводе, в одинарных ковычках

echo 'Первая полка, вторая книга:'.$bookshelf[1][2]['author'].' - '.$bookshelf[1][2]['title'].', '.$bookshelf[1][2]['year'].'<br>';
